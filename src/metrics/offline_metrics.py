...
from src.utils import PandasDataFrame, PolarsDataFrame, SparkDataFrame
...
class OfflineMetrics:
    """
    Designed for efficient calculation of offline metrics provided by the src.
    ...
    6        3        4    1.0
    7        3        9    0.5
    >>> from src.metrics import Median, ConfidenceInterval, PerUser
    >>> metrics = [
    ...     Precision(2),
